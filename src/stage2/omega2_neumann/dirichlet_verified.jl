...
function assemble_dirichlet(N::Int; nt::Int=48, npanel::Int=96, nodes::Vector{IV}, wts::Vector{IV})
...
function dirichlet_upper(N::Int; nt::Int=48, npanel::Int=96, nodes::Vector{IV}, wts::Vector{IV}, verbose=true)
    T0=time()
